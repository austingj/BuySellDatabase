public class user 
{
	    ...
	    public user(String email, String firstName, String lastName, String password, String birthday, String adress_street_num,
	...
	/*
	    public user(String firstName, String lastName, String password,String birthday, String adress_street_num, String adress_street, String adress_city, String adress_state,String adress_zip_code,double eth) 
	    {
	    	this.firstName = firstName;
	    	this.lastName = lastName;
	    	this.password = password;
