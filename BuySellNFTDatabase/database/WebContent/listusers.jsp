...
<% 
 ...
 System.out.println("On listusers.jsp");

%>
<div align = "center">
	

	<a href="activitypage.jsp"target ="_self" > return</a><br><br> 
...
<h1>List all users</h1>
    <div align="center">
        ...
        <table border="3" cellpadding="6">
        	...
        	<a href = "User.jsp?email=${users.email}"target ="_self""><c:out value="${users.email}" /></a></td>
